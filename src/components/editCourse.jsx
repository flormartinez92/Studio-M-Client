...
export default function EditCourse() {
  ...
  const onSubmitForm = async (e) => {
    ...
    } else if (file.name && !file2.name) {
      formData.append("archivo", file);
      formData.append("archivo2", "");
      formData.append("condicion", "2");
    } else if (!file.name && file2.name) {
      formData.append("archivo", "");
  ...
  useEffect(() => {
    ...
    if (courseInfo) {
      ...
      setValueData4(courseData.courseDescription);
      setValueData5(courseData.coursePrice);
      setValueData6(courseData.courseLevel);
      setValueData7(courseData.courseDuration);
      setValueData8(courseData.projectsTitle);
      setValueData9(courseData.projectsDescription);
