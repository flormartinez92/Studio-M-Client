...
export default function Intro() {
  return (
    <div>
      <h1 className="text-5xl text-black font-mystery-mixed p-2 mt-6 mb-6 flex items-center justify-center">
      ...
      <div className="w-full h-full flex flex-col justify-center">
        <h2 className="text-5xl text-black font-mystery-mixed p-2 mt-6 mb-6 flex items-center justify-center">
          Qué esperar de un curso en by M studio?
        </h2>

        <div className="m-3 flex items-start">
          <CheckList className="p-3" icon={<Check />} />
          <p className="font-ms-gothic ml-2 flex-shrink-0">
      ...
      <div className="flex flex-col items-center w-100% relative">
        ...
        <p className="text-5xl text-black font-mystery-mixed absolute top-8">
          Studio by M
        </p>
        <p className="text-2xl text-black font-mystery-mixed absolute top-20">
